...
class ValidVariableNameSniffTest extends CodeSnifferTestCase
{
    ...
    public function testSniff()
    {
        ...
        $this->assertTrue(isset($warnings[10][13][0]["source"]));
        $this->assertEquals(
            "Apnet.NamingConvensions.ValidVariableName.MemberVarContainsNumbers", $warnings[10][13][0]["source"]
        );

        $this->assertTrue(isset($errors[8][13][0]["source"]));
        $this->assertEquals(
            "Apnet.NamingConvensions.ValidVariableName.NotCamelCaps", $errors[8][13][0]["source"]
        );
    }
}
